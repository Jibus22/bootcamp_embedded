...
#define PCA9555_SET_OUT(reg, val) (reg & ~(1 << val))
#define PCA9555_SET_IN(reg, val) (reg | (1 << val))
...
int main() {
  ...
  pca9555_write(CMD_CONF_P0, PCA9555_SET_OUT(0xFF, LED_D9));
  while (1) {
    pca9555_write(CMD_OUT_P0, PCA9555_SET_OUT(0xFF, LED_D9));
    _delay_ms(500);
    pca9555_write(CMD_OUT_P0, PCA9555_SET_IN(0xFF, LED_D9));
    _delay_ms(500);
  }
  return 0;
}
